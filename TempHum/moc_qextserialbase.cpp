...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QextSerialBase_t, stringdata) + ofs \
...
const QMetaObject QextSerialBase::staticMetaObject = {
    { &QIODevice::staticMetaObject, qt_meta_stringdata_QextSerialBase.data,
      qt_meta_data_QextSerialBase,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QextSerialBase.stringdata))
