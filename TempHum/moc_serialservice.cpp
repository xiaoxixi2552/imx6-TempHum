...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SerialService_t, stringdata) + ofs \
...
const QMetaObject SerialService::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SerialService.data,
      qt_meta_data_SerialService,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SerialService.stringdata))
        return static_cast<void*>(const_cast< SerialService*>(this));
